...
- **Plots**: folder with the results coming from the analysis of the trends and the attribution. Each folder presents the result of each R script in the **R** folder. It also included in the folder **QGIS** the two maps of the HN climatology and study area made using the QGIS software
