...
##### DATA #####
Meta <- read.csv("FinalData/MetaData_EURAC.csv", header=T, sep=";")
Data <- read.csv("FinalData/Data_HS.csv", header=T, sep=";")
Data_S <- read.csv("FinalData/Data_HS_S.csv", header=T, sep=";")
...
png(paste0("02_TrendHS/Plots/TrendHS_1.png"), width=1200, height=2400, res=100)
par(mar=c(0.5,0.5,5,0), mgp=c(3,0,0), mfrow=c(4,2))
...
# Plotting #
png(paste0("02_TrendHS/Plots/TrendHS_2.png"), width=2000, height=1000, res=100)
...
png(paste0("02_TrendHS/Plots/TrendHS_3.png"), width=1500, height=1000, res=100)
par(mar=c(3,5,0.5,0.5), mgp=c(3.5,1,0))

plot(NULL, xaxt="n", yaxt="n", ylim=c(-20,20), xlim=c(0.5,12.5), xlab=NA, ylab="Trend [cm/decade]", cex.lab=1.5)
...
axis(side=2, at=seq(-20,20,length.out=11), labels=seq(-20,20,length.out=11), las=2, cex.axis=1.5, tck=-0.01, xaxs="i")
...
png(paste0("02_TrendHS/Plots/TrendHS_3r.png"), width=1500, height=1000, res=100)
par(mar=c(3,5,0.5,0.5), mgp=c(3.5,1,0))

plot(NULL, xaxt="n", yaxt="n", ylim=c(-30,30), xlim=c(0.5,12.5), xlab=NA, ylab="Relative Trend [%]", cex.lab=1.5)
abline(h=0, col="black", lty=2, lwd=3)
